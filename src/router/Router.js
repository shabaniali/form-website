// ** React Imports
import { Suspense, useContext, lazy, useState, useEffect } from 'react'
...
const Router = () => {
  ...
  useEffect(() => {
    setDefaultRoute(getHomeRouteForLoggedInUser(userData.role))
  }, [userData])
  ...
  const FinalRoute = props => {
    ...
    if (isUserLoggedIn()) {
      if (route.meta && route.meta.role) {
        ...
        if (role.length ? role.includes(userData.role) : false) {
